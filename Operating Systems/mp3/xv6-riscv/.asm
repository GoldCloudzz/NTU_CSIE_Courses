...
void thrdstop_handler_resume_main_id(void *arg)
{
    ...
    thrdresume(main_id);  // jump to line 23
      ...
      10:	06c78793          	addi	a5,a5,108 # 2078 <main_id>
      14:	439c                	lw	a5,0(a5)
      16:	853e                	mv	a0,a5
...
int test_multi_context()
{
    ...
    if (v2 == 77) {
      ...
      7c:	01078793          	addi	a5,a5,16 # 2088 <v2.1>
      80:	439c                	lw	a5,0(a5)
      82:	873e                	mv	a4,a5
      ...
      9e:	fe278793          	addi	a5,a5,-30 # 207c <second_id>
      a2:	439c                	lw	a5,0(a5)
      a4:	853e                	mv	a0,a5
    ...
    while (v1 == 0) {
      ...
      f2:	f9e78793          	addi	a5,a5,-98 # 208c <v1.0>
      f6:	439c                	lw	a5,0(a5)
...
int main(int argc, char **argv)
{
    ...
    fprintf(2, "[%s] %s\n", result ? "FAILED" : "OK", "test_multi_context");
     ...
     15e:	d7e78793          	addi	a5,a5,-642 # 1ed8 <schedule_rm+0x27e>
     162:	a029                	j	16c <main+0x3a>
     164:	00002797          	auipc	a5,0x2
     168:	d7c78793          	addi	a5,a5,-644 # 1ee0 <schedule_rm+0x286>
     16c:	00002697          	auipc	a3,0x2
     170:	d7c68693          	addi	a3,a3,-644 # 1ee8 <schedule_rm+0x28e>
     174:	863e                	mv	a2,a5
     176:	00002597          	auipc	a1,0x2
     17a:	d8a58593          	addi	a1,a1,-630 # 1f00 <schedule_rm+0x2a6>
     17e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     78a:	8ba68693          	addi	a3,a3,-1862 # 2040 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     864:	7e070713          	addi	a4,a4,2016 # 2040 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     a24:	4f078793          	addi	a5,a5,1264 # 1f10 <schedule_rm+0x2b6>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     bd0:	4d478793          	addi	a5,a5,1236 # 20a0 <freep>
     bd4:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     cc8:	3dc78793          	addi	a5,a5,988 # 20a0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     d4a:	35a78793          	addi	a5,a5,858 # 20a0 <freep>
     d4e:	639c                	ld	a5,0(a5)
}
     d50:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d7c:	32878793          	addi	a5,a5,808 # 20a0 <freep>
     d80:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d90:	30478793          	addi	a5,a5,772 # 2090 <base>
     d94:	fef43023          	sd	a5,-32(s0)
     d98:	00001797          	auipc	a5,0x1
     d9c:	30878793          	addi	a5,a5,776 # 20a0 <freep>
     da0:	fe043703          	ld	a4,-32(s0)
     da4:	e398                	sd	a4,0(a5)
     da6:	00001797          	auipc	a5,0x1
     daa:	2fa78793          	addi	a5,a5,762 # 20a0 <freep>
     dae:	6398                	ld	a4,0(a5)
     db0:	00001797          	auipc	a5,0x1
     db4:	2e078793          	addi	a5,a5,736 # 2090 <base>
     db8:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     dba:	00001797          	auipc	a5,0x1
     dbe:	2d678793          	addi	a5,a5,726 # 2090 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     e3a:	26a78793          	addi	a5,a5,618 # 20a0 <freep>
    ...
    if(p == freep)
     ...
     e50:	25478793          	addi	a5,a5,596 # 20a0 <freep>
     e54:	639c                	ld	a5,0(a5)
...
static inline void list_del(struct list_head *entry)
{
    ...
    entry->next = LIST_POISON1;
     ...
     fd8:	10070713          	addi	a4,a4,256 # 100100 <__global_pointer$+0xfd8c0>
     fdc:	e398                	sd	a4,0(a5)
    entry->prev = LIST_POISON2;
     fde:	fe843783          	ld	a5,-24(s0)
     fe2:	00200737          	lui	a4,0x200
     fe6:	20070713          	addi	a4,a4,512 # 200200 <__global_pointer$+0x1fd9c0>
     fea:	e798                	sd	a4,8(a5)
}
     fec:	0001                	nop
...
void thread_add_at(struct thread *t, int arrival_time)
{
    ...
    1148:	f2458593          	addi	a1,a1,-220 # 2068 <release_queue>
    114c:	853e                	mv	a0,a5
...
void __release()
{
    ...
    116c:	f0078793          	addi	a5,a5,-256 # 2068 <release_queue>
    ...
    11a0:	f1478793          	addi	a5,a5,-236 # 20b0 <threading_system_time>
    ...
    11e2:	e7a58593          	addi	a1,a1,-390 # 2058 <run_queue>
    11e6:	853e                	mv	a0,a5
    ...
    1234:	e3878793          	addi	a5,a5,-456 # 2068 <release_queue>
...
void __thread_exit(struct thread *to_remove)
{
    ...
    125e:	e4e78793          	addi	a5,a5,-434 # 20a8 <current>
    ...
    12a6:	dde78793          	addi	a5,a5,-546 # 2080 <main_thrd_id>
...
void thread_exit(void)
{
    ...
    12cc:	de078793          	addi	a5,a5,-544 # 20a8 <current>
    12d0:	6398                	ld	a4,0(a5)
    12d2:	00001797          	auipc	a5,0x1
    12d6:	d8678793          	addi	a5,a5,-634 # 2058 <run_queue>
    ...
    12e2:	c3a58593          	addi	a1,a1,-966 # 1f18 <schedule_rm+0x2be>
    12e6:	4509                	li	a0,2
    ...
    12fe:	dae78793          	addi	a5,a5,-594 # 20a8 <current>
...
void __finish_current()
{
    ...
    1374:	d3878793          	addi	a5,a5,-712 # 20a8 <current>
    ...
    13a6:	d0e78793          	addi	a5,a5,-754 # 20b0 <threading_system_time>
    ...
    13ba:	b9a50513          	addi	a0,a0,-1126 # 1f50 <schedule_rm+0x2f6>
...
void switch_handler(void *arg)
{
    ...
    1444:	c6878793          	addi	a5,a5,-920 # 20a8 <current>
    ...
    1466:	c4e78793          	addi	a5,a5,-946 # 20b0 <threading_system_time>
    ...
    147a:	c3a78793          	addi	a5,a5,-966 # 20b0 <threading_system_time>
    ...
    14b2:	c0278793          	addi	a5,a5,-1022 # 20b0 <threading_system_time>
    ...
    14c6:	bee78793          	addi	a5,a5,-1042 # 20b0 <threading_system_time>
    ...
    14e4:	bd078793          	addi	a5,a5,-1072 # 20b0 <threading_system_time>
    14e8:	439c                	lw	a5,0(a5)
    14ea:	863e                	mv	a2,a5
    14ec:	85ba                	mv	a1,a4
    14ee:	00001517          	auipc	a0,0x1
    14f2:	a9a50513          	addi	a0,a0,-1382 # 1f88 <schedule_rm+0x32e>
    ...
    1536:	b4e78793          	addi	a5,a5,-1202 # 2080 <main_thrd_id>
...
void __dispatch()
{
    ...
    155c:	b5078793          	addi	a5,a5,-1200 # 20a8 <current>
    1560:	6398                	ld	a4,0(a5)
    1562:	00001797          	auipc	a5,0x1
    1566:	af678793          	addi	a5,a5,-1290 # 2058 <run_queue>
    ...
    1572:	b3a78793          	addi	a5,a5,-1222 # 20a8 <current>
    ...
    158c:	b3078793          	addi	a5,a5,-1232 # 20b8 <allocated_time>
    ...
    15a8:	9e450513          	addi	a0,a0,-1564 # 1f88 <schedule_rm+0x32e>
    ...
    15c8:	aec78793          	addi	a5,a5,-1300 # 20b0 <threading_system_time>
    15cc:	4390                	lw	a2,0(a5)
    15ce:	00001797          	auipc	a5,0x1
    15d2:	aea78793          	addi	a5,a5,-1302 # 20b8 <allocated_time>
    15d6:	639c                	ld	a5,0(a5)
    15d8:	86be                	mv	a3,a5
    15da:	85ba                	mv	a1,a4
    15dc:	00001517          	auipc	a0,0x1
    15e0:	9d450513          	addi	a0,a0,-1580 # 1fb0 <schedule_rm+0x356>
    ...
    15f8:	ac478793          	addi	a5,a5,-1340 # 20b8 <allocated_time>
    ...
    160e:	aae78793          	addi	a5,a5,-1362 # 20b8 <allocated_time>
    ...
    1658:	a6478793          	addi	a5,a5,-1436 # 20b8 <allocated_time>
    ...
    166e:	a4e78793          	addi	a5,a5,-1458 # 20b8 <allocated_time>
    ...
    1696:	94e58593          	addi	a1,a1,-1714 # 1fe0 <schedule_rm+0x386>
    169a:	4509                	li	a0,2
...
void __schedule(void)
{
    ...
    16e4:	9d078793          	addi	a5,a5,-1584 # 20b0 <threading_system_time>
    16e8:	439c                	lw	a5,0(a5)
    16ea:	fcf42c23          	sw	a5,-40(s0)
    16ee:	00001797          	auipc	a5,0x1
    16f2:	96a78793          	addi	a5,a5,-1686 # 2058 <run_queue>
    16f6:	fef43023          	sd	a5,-32(s0)
    16fa:	00001797          	auipc	a5,0x1
    16fe:	96e78793          	addi	a5,a5,-1682 # 2068 <release_queue>
...
void back_to_main_handler(void *arg)
{
    ...
    1770:	94878793          	addi	a5,a5,-1720 # 20b4 <sleeping>
    ...
    1784:	93078793          	addi	a5,a5,-1744 # 20b0 <threading_system_time>
    ...
    1798:	91c78793          	addi	a5,a5,-1764 # 20b0 <threading_system_time>
    179c:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
    179e:	00001797          	auipc	a5,0x1
    17a2:	8e278793          	addi	a5,a5,-1822 # 2080 <main_thrd_id>
...
void thread_start_threading()
{
    ...
    17c8:	8ec78793          	addi	a5,a5,-1812 # 20b0 <threading_system_time>
    17cc:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
    17d0:	00001797          	auipc	a5,0x1
    17d4:	8d878793          	addi	a5,a5,-1832 # 20a8 <current>
    17d8:	00001717          	auipc	a4,0x1
    17dc:	88070713          	addi	a4,a4,-1920 # 2058 <run_queue>
    ...
    17f0:	89458593          	addi	a1,a1,-1900 # 2080 <main_thrd_id>
    ...
    1804:	88078793          	addi	a5,a5,-1920 # 2080 <main_thrd_id>
    ...
    182c:	85878793          	addi	a5,a5,-1960 # 2080 <main_thrd_id>
    ...
    184a:	81250513          	addi	a0,a0,-2030 # 2058 <run_queue>
    ...
    185e:	80e50513          	addi	a0,a0,-2034 # 2068 <release_queue>
    ...
    1872:	84a78793          	addi	a5,a5,-1974 # 20b8 <allocated_time>
    1876:	639c                	ld	a5,0(a5)
    1878:	85be                	mv	a1,a5
    187a:	00000517          	auipc	a0,0x0
    187e:	79e50513          	addi	a0,a0,1950 # 2018 <schedule_rm+0x3be>
    1882:	fffff097          	auipc	ra,0xfffff
    1886:	2e6080e7          	jalr	742(ra) # b68 <printf>
        sleeping = 1;
    188a:	00001797          	auipc	a5,0x1
    188e:	82a78793          	addi	a5,a5,-2006 # 20b4 <sleeping>
    1892:	4705                	li	a4,1
    ...
    189a:	82278793          	addi	a5,a5,-2014 # 20b8 <allocated_time>
    189e:	639c                	ld	a5,0(a5)
    18a0:	0007871b          	sext.w	a4,a5
    18a4:	00001797          	auipc	a5,0x1
    18a8:	81478793          	addi	a5,a5,-2028 # 20b8 <allocated_time>
    ...
    18bc:	7c858593          	addi	a1,a1,1992 # 2080 <main_thrd_id>
    18c0:	853a                	mv	a0,a4
    ...
    18f0:	77c50513          	addi	a0,a0,1916 # 2068 <release_queue>
...
struct threads_sched_result schedule_edf(struct threads_sched_args args)
{
    ...
    19d8:	fe043423          	sd	zero,-24(s0)
    struct thread *th = NULL;
    19dc:	fe043023          	sd	zero,-32(s0)

    list_for_each_entry(th, args.run_queue, thread_list) {
    19e0:	649c                	ld	a5,8(s1)
    19e2:	639c                	ld	a5,0(a5)
    19e4:	faf43c23          	sd	a5,-72(s0)
    19e8:	fb843783          	ld	a5,-72(s0)
    19ec:	fd878793          	addi	a5,a5,-40
    19f0:	fef43023          	sd	a5,-32(s0)
    19f4:	a089                	j	1a36 <schedule_edf+0x68>
        if (th->current_deadline <= args.current_time && (thread_missed == NULL || th->ID < thread_missed->ID))
    19f6:	fe043783          	ld	a5,-32(s0)
    19fa:	4bb8                	lw	a4,80(a5)
    19fc:	409c                	lw	a5,0(s1)
    19fe:	02e7c163          	blt	a5,a4,1a20 <schedule_edf+0x52>
    1a02:	fe843783          	ld	a5,-24(s0)
    1a06:	cb89                	beqz	a5,1a18 <schedule_edf+0x4a>
    1a08:	fe043783          	ld	a5,-32(s0)
    1a0c:	5398                	lw	a4,32(a5)
    1a0e:	fe843783          	ld	a5,-24(s0)
    1a12:	539c                	lw	a5,32(a5)
    1a14:	00f75663          	bge	a4,a5,1a20 <schedule_edf+0x52>
            thread_missed = th;
    1a18:	fe043783          	ld	a5,-32(s0)
    1a1c:	fef43423          	sd	a5,-24(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1a20:	fe043783          	ld	a5,-32(s0)
    1a24:	779c                	ld	a5,40(a5)
    1a26:	f8f43023          	sd	a5,-128(s0)
    1a2a:	f8043783          	ld	a5,-128(s0)
    1a2e:	fd878793          	addi	a5,a5,-40
    1a32:	fef43023          	sd	a5,-32(s0)
    1a36:	fe043783          	ld	a5,-32(s0)
    1a3a:	02878713          	addi	a4,a5,40
    1a3e:	649c                	ld	a5,8(s1)
    1a40:	faf71be3          	bne	a4,a5,19f6 <schedule_edf+0x28>
    }

    struct thread *thread_ed = NULL;
    1a44:	fc043c23          	sd	zero,-40(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1a48:	649c                	ld	a5,8(s1)
    1a4a:	639c                	ld	a5,0(a5)
    1a4c:	faf43823          	sd	a5,-80(s0)
    1a50:	fb043783          	ld	a5,-80(s0)
    1a54:	fd878793          	addi	a5,a5,-40
    1a58:	fef43023          	sd	a5,-32(s0)
    1a5c:	a899                	j	1ab2 <schedule_edf+0xe4>
    ...
    1a5e:	fd843783          	ld	a5,-40(s0)
    1a62:	cb8d                	beqz	a5,1a94 <schedule_edf+0xc6>
    1a64:	fe043783          	ld	a5,-32(s0)
    1a68:	4bb8                	lw	a4,80(a5)
    1a6a:	fd843783          	ld	a5,-40(s0)
    1a6e:	4bbc                	lw	a5,80(a5)
    1a70:	02f74263          	blt	a4,a5,1a94 <schedule_edf+0xc6>
    1a74:	fe043783          	ld	a5,-32(s0)
    1a78:	4bb8                	lw	a4,80(a5)
    1a7a:	fd843783          	ld	a5,-40(s0)
    1a7e:	4bbc                	lw	a5,80(a5)
    1a80:	00f71e63          	bne	a4,a5,1a9c <schedule_edf+0xce>
    1a84:	fe043783          	ld	a5,-32(s0)
    1a88:	5398                	lw	a4,32(a5)
    1a8a:	fd843783          	ld	a5,-40(s0)
    1a8e:	539c                	lw	a5,32(a5)
    1a90:	00f75663          	bge	a4,a5,1a9c <schedule_edf+0xce>
            thread_ed = th;
    1a94:	fe043783          	ld	a5,-32(s0)
    1a98:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1a9c:	fe043783          	ld	a5,-32(s0)
    1aa0:	779c                	ld	a5,40(a5)
    1aa2:	f8f43423          	sd	a5,-120(s0)
    1aa6:	f8843783          	ld	a5,-120(s0)
    1aaa:	fd878793          	addi	a5,a5,-40
    1aae:	fef43023          	sd	a5,-32(s0)
    1ab2:	fe043783          	ld	a5,-32(s0)
    1ab6:	02878713          	addi	a4,a5,40
    1aba:	649c                	ld	a5,8(s1)
    1abc:	faf711e3          	bne	a4,a5,1a5e <schedule_edf+0x90>
    }

    struct threads_sched_result r;
    struct release_queue_entry *entry = NULL;
    1ac0:	fc043823          	sd	zero,-48(s0)

    // There is a thread that has already missed its current deadline
    if (thread_missed != NULL){
    1ac4:	fe843783          	ld	a5,-24(s0)
    1ac8:	cb91                	beqz	a5,1adc <schedule_edf+0x10e>
        r.scheduled_thread_list_member = &thread_missed->thread_list;
    1aca:	fe843783          	ld	a5,-24(s0)
    1ace:	02878793          	addi	a5,a5,40
    1ad2:	f6f43023          	sd	a5,-160(s0)
        r.allocated_time = 0;
    1ad6:	f6042423          	sw	zero,-152(s0)
    1ada:	aa91                	j	1c2e <schedule_edf+0x260>
    }

    else if (thread_ed != NULL) {
    1adc:	fd843783          	ld	a5,-40(s0)
    1ae0:	cfe9                	beqz	a5,1bba <schedule_edf+0x1ec>
        r.scheduled_thread_list_member = &thread_ed->thread_list;
    1ae2:	fd843783          	ld	a5,-40(s0)
    1ae6:	02878793          	addi	a5,a5,40
    1aea:	f6f43023          	sd	a5,-160(s0)

        struct thread *thread_next_ed = NULL;
    1aee:	fc043423          	sd	zero,-56(s0)
        list_for_each_entry(entry, args.release_queue, thread_list) {
    1af2:	689c                	ld	a5,16(s1)
    1af4:	639c                	ld	a5,0(a5)
    1af6:	f8f43c23          	sd	a5,-104(s0)
    1afa:	f9843783          	ld	a5,-104(s0)
    1afe:	17e1                	addi	a5,a5,-8
    1b00:	fcf43823          	sd	a5,-48(s0)
    1b04:	a8a9                	j	1b5e <schedule_edf+0x190>
    ...
    1b06:	fd043783          	ld	a5,-48(s0)
    1b0a:	639c                	ld	a5,0(a5)
    1b0c:	4bac                	lw	a1,80(a5)
    1b0e:	4098                	lw	a4,0(s1)
    1b10:	fd843783          	ld	a5,-40(s0)
    1b14:	47fc                	lw	a5,76(a5)
    1b16:	9fb9                	addw	a5,a5,a4
    1b18:	2781                	sext.w	a5,a5
    1b1a:	872e                	mv	a4,a1
    1b1c:	02f75763          	bge	a4,a5,1b4a <schedule_edf+0x17c>
    1b20:	fd043783          	ld	a5,-48(s0)
    1b24:	639c                	ld	a5,0(a5)
    1b26:	4bb8                	lw	a4,80(a5)
    1b28:	fd043783          	ld	a5,-48(s0)
    1b2c:	639c                	ld	a5,0(a5)
    1b2e:	43fc                	lw	a5,68(a5)
    1b30:	9fb9                	addw	a5,a5,a4
    1b32:	0007871b          	sext.w	a4,a5
    1b36:	fd843783          	ld	a5,-40(s0)
    1b3a:	4bbc                	lw	a5,80(a5)
    1b3c:	00f75763          	bge	a4,a5,1b4a <schedule_edf+0x17c>
                thread_next_ed = entry->thrd;
    1b40:	fd043783          	ld	a5,-48(s0)
    1b44:	639c                	ld	a5,0(a5)
    1b46:	fcf43423          	sd	a5,-56(s0)
        list_for_each_entry(entry, args.release_queue, thread_list) {
    1b4a:	fd043783          	ld	a5,-48(s0)
    1b4e:	679c                	ld	a5,8(a5)
    1b50:	f8f43823          	sd	a5,-112(s0)
    1b54:	f9043783          	ld	a5,-112(s0)
    1b58:	17e1                	addi	a5,a5,-8
    1b5a:	fcf43823          	sd	a5,-48(s0)
    1b5e:	fd043783          	ld	a5,-48(s0)
    1b62:	00878713          	addi	a4,a5,8
    1b66:	689c                	ld	a5,16(s1)
    1b68:	f8f71fe3          	bne	a4,a5,1b06 <schedule_edf+0x138>
        }

        if (thread_next_ed != NULL)
    1b6c:	fc843783          	ld	a5,-56(s0)
    1b70:	cb99                	beqz	a5,1b86 <schedule_edf+0x1b8>
            r.allocated_time = (thread_next_ed->current_deadline - args.current_time);
    1b72:	fc843783          	ld	a5,-56(s0)
    1b76:	4bb8                	lw	a4,80(a5)
    1b78:	409c                	lw	a5,0(s1)
    1b7a:	40f707bb          	subw	a5,a4,a5
    1b7e:	2781                	sext.w	a5,a5
    1b80:	f6f42423          	sw	a5,-152(s0)
    1b84:	a031                	j	1b90 <schedule_edf+0x1c2>
            
        else
            r.allocated_time = thread_ed->remaining_time;
    1b86:	fd843783          	ld	a5,-40(s0)
    1b8a:	47fc                	lw	a5,76(a5)
    1b8c:	f6f42423          	sw	a5,-152(s0)

        if (args.current_time + r.allocated_time > thread_ed->current_deadline)
    1b90:	4098                	lw	a4,0(s1)
    1b92:	f6842783          	lw	a5,-152(s0)
    1b96:	9fb9                	addw	a5,a5,a4
    1b98:	0007871b          	sext.w	a4,a5
    1b9c:	fd843783          	ld	a5,-40(s0)
    1ba0:	4bbc                	lw	a5,80(a5)
    1ba2:	08e7d663          	bge	a5,a4,1c2e <schedule_edf+0x260>
            r.allocated_time = thread_ed->current_deadline - args.current_time;
    1ba6:	fd843783          	ld	a5,-40(s0)
    1baa:	4bb8                	lw	a4,80(a5)
    1bac:	409c                	lw	a5,0(s1)
    1bae:	40f707bb          	subw	a5,a4,a5
    1bb2:	2781                	sext.w	a5,a5
    1bb4:	f6f42423          	sw	a5,-152(s0)
    1bb8:	a89d                	j	1c2e <schedule_edf+0x260>
    }
    ...
    1bbc:	f6f43023          	sd	a5,-160(s0)

        struct thread *thread_first = NULL;
    1bc0:	fc043023          	sd	zero,-64(s0)
        list_for_each_entry(entry, args.release_queue, thread_list) {
    1bc4:	689c                	ld	a5,16(s1)
    1bc6:	639c                	ld	a5,0(a5)
    1bc8:	faf43423          	sd	a5,-88(s0)
    1bcc:	fa843783          	ld	a5,-88(s0)
    1bd0:	17e1                	addi	a5,a5,-8
    1bd2:	fcf43823          	sd	a5,-48(s0)
    1bd6:	a825                	j	1c0e <schedule_edf+0x240>
            if (thread_first == NULL || entry->thrd->current_deadline < thread_first->current_deadline)
    1bd8:	fc043783          	ld	a5,-64(s0)
    1bdc:	cb91                	beqz	a5,1bf0 <schedule_edf+0x222>
    1bde:	fd043783          	ld	a5,-48(s0)
    1be2:	639c                	ld	a5,0(a5)
    1be4:	4bb8                	lw	a4,80(a5)
    1be6:	fc043783          	ld	a5,-64(s0)
    1bea:	4bbc                	lw	a5,80(a5)
    1bec:	00f75763          	bge	a4,a5,1bfa <schedule_edf+0x22c>
                thread_first = entry->thrd;
    1bf0:	fd043783          	ld	a5,-48(s0)
    1bf4:	639c                	ld	a5,0(a5)
    1bf6:	fcf43023          	sd	a5,-64(s0)
        list_for_each_entry(entry, args.release_queue, thread_list) {
    1bfa:	fd043783          	ld	a5,-48(s0)
    1bfe:	679c                	ld	a5,8(a5)
    1c00:	faf43023          	sd	a5,-96(s0)
    1c04:	fa043783          	ld	a5,-96(s0)
    1c08:	17e1                	addi	a5,a5,-8
    1c0a:	fcf43823          	sd	a5,-48(s0)
    1c0e:	fd043783          	ld	a5,-48(s0)
    1c12:	00878713          	addi	a4,a5,8
    1c16:	689c                	ld	a5,16(s1)
    1c18:	fcf710e3          	bne	a4,a5,1bd8 <schedule_edf+0x20a>
        }
        r.allocated_time = (thread_first->current_deadline - args.current_time);
    1c1c:	fc043783          	ld	a5,-64(s0)
    1c20:	4bb8                	lw	a4,80(a5)
    1c22:	409c                	lw	a5,0(s1)
    1c24:	40f707bb          	subw	a5,a4,a5
    1c28:	2781                	sext.w	a5,a5
    1c2a:	f6f42423          	sw	a5,-152(s0)
    }

    return r;
    1c2e:	f6043783          	ld	a5,-160(s0)
    1c32:	f6f43823          	sd	a5,-144(s0)
    1c36:	f6843783          	ld	a5,-152(s0)
    1c3a:	f6f43c23          	sd	a5,-136(s0)
    1c3e:	f7043703          	ld	a4,-144(s0)
    1c42:	f7843783          	ld	a5,-136(s0)
    1c46:	863a                	mv	a2,a4
    1c48:	86be                	mv	a3,a5
    1c4a:	8732                	mv	a4,a2
    1c4c:	87b6                	mv	a5,a3
    ...
    1c4e:	853a                	mv	a0,a4
    1c50:	85be                	mv	a1,a5
    1c52:	646a                	ld	s0,152(sp)
    1c54:	64ca                	ld	s1,144(sp)
    1c56:	610d                	addi	sp,sp,160
    1c58:	8082                	ret

0000000000001c5a <schedule_rm>:

/* Rate-Monotonic Scheduling */
struct threads_sched_result schedule_rm(struct threads_sched_args args)
{
    1c5a:	7135                	addi	sp,sp,-160
    1c5c:	ed22                	sd	s0,152(sp)
    1c5e:	e926                	sd	s1,144(sp)
    1c60:	1100                	addi	s0,sp,160
    1c62:	84aa                	mv	s1,a0
    struct thread *thread_missed = NULL;
    ...
    1c70:	faf43c23          	sd	a5,-72(s0)
    1c74:	fb843783          	ld	a5,-72(s0)
    1c78:	fd878793          	addi	a5,a5,-40
    1c7c:	fef43023          	sd	a5,-32(s0)
    1c80:	a089                	j	1cc2 <schedule_rm+0x68>
        if (th->current_deadline <= args.current_time && (thread_missed == NULL || th->ID < thread_missed->ID))
    1c82:	fe043783          	ld	a5,-32(s0)
    1c86:	4bb8                	lw	a4,80(a5)
    1c88:	409c                	lw	a5,0(s1)
    1c8a:	02e7c163          	blt	a5,a4,1cac <schedule_rm+0x52>
    1c8e:	fe843783          	ld	a5,-24(s0)
    1c92:	cb89                	beqz	a5,1ca4 <schedule_rm+0x4a>
    1c94:	fe043783          	ld	a5,-32(s0)
    1c98:	5398                	lw	a4,32(a5)
    1c9a:	fe843783          	ld	a5,-24(s0)
    1c9e:	539c                	lw	a5,32(a5)
    1ca0:	00f75663          	bge	a4,a5,1cac <schedule_rm+0x52>
            thread_missed = th;
    1ca4:	fe043783          	ld	a5,-32(s0)
    1ca8:	fef43423          	sd	a5,-24(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1cac:	fe043783          	ld	a5,-32(s0)
    1cb0:	779c                	ld	a5,40(a5)
    1cb2:	f8f43023          	sd	a5,-128(s0)
    1cb6:	f8043783          	ld	a5,-128(s0)
    1cba:	fd878793          	addi	a5,a5,-40
    1cbe:	fef43023          	sd	a5,-32(s0)
    1cc2:	fe043783          	ld	a5,-32(s0)
    1cc6:	02878713          	addi	a4,a5,40
    1cca:	649c                	ld	a5,8(s1)
    1ccc:	faf71be3          	bne	a4,a5,1c82 <schedule_rm+0x28>
    }

    struct thread *thread_sp = NULL;
    1cd0:	fc043c23          	sd	zero,-40(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1cd4:	649c                	ld	a5,8(s1)
    1cd6:	639c                	ld	a5,0(a5)
    1cd8:	faf43823          	sd	a5,-80(s0)
    1cdc:	fb043783          	ld	a5,-80(s0)
    1ce0:	fd878793          	addi	a5,a5,-40
    1ce4:	fef43023          	sd	a5,-32(s0)
    1ce8:	a899                	j	1d3e <schedule_rm+0xe4>
        if (thread_sp == NULL || th->period < thread_sp->period || (th->period == thread_sp->period && th->ID < thread_sp->ID))
    1cea:	fd843783          	ld	a5,-40(s0)
    1cee:	cb8d                	beqz	a5,1d20 <schedule_rm+0xc6>
    1cf0:	fe043783          	ld	a5,-32(s0)
    1cf4:	43f8                	lw	a4,68(a5)
    1cf6:	fd843783          	ld	a5,-40(s0)
    1cfa:	43fc                	lw	a5,68(a5)
    1cfc:	02f74263          	blt	a4,a5,1d20 <schedule_rm+0xc6>
    1d00:	fe043783          	ld	a5,-32(s0)
    1d04:	43f8                	lw	a4,68(a5)
    1d06:	fd843783          	ld	a5,-40(s0)
    1d0a:	43fc                	lw	a5,68(a5)
    1d0c:	00f71e63          	bne	a4,a5,1d28 <schedule_rm+0xce>
    1d10:	fe043783          	ld	a5,-32(s0)
    1d14:	5398                	lw	a4,32(a5)
    1d16:	fd843783          	ld	a5,-40(s0)
    1d1a:	539c                	lw	a5,32(a5)
    1d1c:	00f75663          	bge	a4,a5,1d28 <schedule_rm+0xce>
            thread_sp = th;
    1d20:	fe043783          	ld	a5,-32(s0)
    1d24:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1d28:	fe043783          	ld	a5,-32(s0)
    1d2c:	779c                	ld	a5,40(a5)
    1d2e:	f8f43423          	sd	a5,-120(s0)
    1d32:	f8843783          	ld	a5,-120(s0)
    1d36:	fd878793          	addi	a5,a5,-40
    1d3a:	fef43023          	sd	a5,-32(s0)
    1d3e:	fe043783          	ld	a5,-32(s0)
    1d42:	02878713          	addi	a4,a5,40
    1d46:	649c                	ld	a5,8(s1)
    1d48:	faf711e3          	bne	a4,a5,1cea <schedule_rm+0x90>
    }

    struct threads_sched_result r;
    struct release_queue_entry *entry = NULL;
    1d4c:	fc043823          	sd	zero,-48(s0)

    // There is a thread that has already missed its current deadline
    if (thread_missed != NULL){
    1d50:	fe843783          	ld	a5,-24(s0)
    1d54:	cb91                	beqz	a5,1d68 <schedule_rm+0x10e>
        r.scheduled_thread_list_member = &thread_missed->thread_list;
    1d56:	fe843783          	ld	a5,-24(s0)
    1d5a:	02878793          	addi	a5,a5,40
    1d5e:	f6f43023          	sd	a5,-160(s0)
        r.allocated_time = 0;
    1d62:	f6042423          	sw	zero,-152(s0)
    1d66:	a299                	j	1eac <schedule_rm+0x252>
    }

    else if (thread_sp != NULL) {
    1d68:	fd843783          	ld	a5,-40(s0)
    1d6c:	c7f1                	beqz	a5,1e38 <schedule_rm+0x1de>
        r.scheduled_thread_list_member = &thread_sp->thread_list;
    1d6e:	fd843783          	ld	a5,-40(s0)
    1d72:	02878793          	addi	a5,a5,40
    1d76:	f6f43023          	sd	a5,-160(s0)

        struct thread *thread_next_sp = NULL;
    1d7a:	fc043423          	sd	zero,-56(s0)
        list_for_each_entry(entry, args.release_queue, thread_list) {
    1d7e:	689c                	ld	a5,16(s1)
    1d80:	639c                	ld	a5,0(a5)
    1d82:	f8f43c23          	sd	a5,-104(s0)
    1d86:	f9843783          	ld	a5,-104(s0)
    1d8a:	17e1                	addi	a5,a5,-8
    1d8c:	fcf43823          	sd	a5,-48(s0)
    1d90:	a0b1                	j	1ddc <schedule_rm+0x182>
            if ((entry->thrd->current_deadline < (args.current_time + thread_sp->remaining_time)) && (entry->thrd->period < thread_sp->period))
    1d92:	fd043783          	ld	a5,-48(s0)
    1d96:	639c                	ld	a5,0(a5)
    1d98:	4bac                	lw	a1,80(a5)
    1d9a:	4098                	lw	a4,0(s1)
    1d9c:	fd843783          	ld	a5,-40(s0)
    1da0:	47fc                	lw	a5,76(a5)
    1da2:	9fb9                	addw	a5,a5,a4
    1da4:	2781                	sext.w	a5,a5
    1da6:	872e                	mv	a4,a1
    1da8:	02f75063          	bge	a4,a5,1dc8 <schedule_rm+0x16e>
    1dac:	fd043783          	ld	a5,-48(s0)
    1db0:	639c                	ld	a5,0(a5)
    1db2:	43f8                	lw	a4,68(a5)
    1db4:	fd843783          	ld	a5,-40(s0)
    1db8:	43fc                	lw	a5,68(a5)
    1dba:	00f75763          	bge	a4,a5,1dc8 <schedule_rm+0x16e>
                thread_next_sp = entry->thrd;
    1dbe:	fd043783          	ld	a5,-48(s0)
    1dc2:	639c                	ld	a5,0(a5)
    1dc4:	fcf43423          	sd	a5,-56(s0)
        list_for_each_entry(entry, args.release_queue, thread_list) {
    1dc8:	fd043783          	ld	a5,-48(s0)
    1dcc:	679c                	ld	a5,8(a5)
    1dce:	f8f43823          	sd	a5,-112(s0)
    1dd2:	f9043783          	ld	a5,-112(s0)
    1dd6:	17e1                	addi	a5,a5,-8
    1dd8:	fcf43823          	sd	a5,-48(s0)
    1ddc:	fd043783          	ld	a5,-48(s0)
    1de0:	00878713          	addi	a4,a5,8
    1de4:	689c                	ld	a5,16(s1)
    1de6:	faf716e3          	bne	a4,a5,1d92 <schedule_rm+0x138>
        }

        if (thread_next_sp != NULL)
    1dea:	fc843783          	ld	a5,-56(s0)
    1dee:	cb99                	beqz	a5,1e04 <schedule_rm+0x1aa>
            r.allocated_time = (thread_next_sp->current_deadline - args.current_time);
    1df0:	fc843783          	ld	a5,-56(s0)
    1df4:	4bb8                	lw	a4,80(a5)
    1df6:	409c                	lw	a5,0(s1)
    1df8:	40f707bb          	subw	a5,a4,a5
    1dfc:	2781                	sext.w	a5,a5
    1dfe:	f6f42423          	sw	a5,-152(s0)
    1e02:	a031                	j	1e0e <schedule_rm+0x1b4>
            
        else
            r.allocated_time = thread_sp->remaining_time;
    1e04:	fd843783          	ld	a5,-40(s0)
    1e08:	47fc                	lw	a5,76(a5)
    1e0a:	f6f42423          	sw	a5,-152(s0)

        if (args.current_time + r.allocated_time > thread_sp->current_deadline)
    1e0e:	4098                	lw	a4,0(s1)
    1e10:	f6842783          	lw	a5,-152(s0)
    1e14:	9fb9                	addw	a5,a5,a4
    1e16:	0007871b          	sext.w	a4,a5
    1e1a:	fd843783          	ld	a5,-40(s0)
    1e1e:	4bbc                	lw	a5,80(a5)
    1e20:	08e7d663          	bge	a5,a4,1eac <schedule_rm+0x252>
            r.allocated_time = thread_sp->current_deadline - args.current_time;
    1e24:	fd843783          	ld	a5,-40(s0)
    1e28:	4bb8                	lw	a4,80(a5)
    1e2a:	409c                	lw	a5,0(s1)
    1e2c:	40f707bb          	subw	a5,a4,a5
    1e30:	2781                	sext.w	a5,a5
    1e32:	f6f42423          	sw	a5,-152(s0)
    1e36:	a89d                	j	1eac <schedule_rm+0x252>
    }
    ...
    1e3a:	f6f43023          	sd	a5,-160(s0)

        struct thread *thread_first = NULL;
    1e3e:	fc043023          	sd	zero,-64(s0)
        list_for_each_entry(entry, args.release_queue, thread_list) {
    1e42:	689c                	ld	a5,16(s1)
    1e44:	639c                	ld	a5,0(a5)
    1e46:	faf43423          	sd	a5,-88(s0)
    1e4a:	fa843783          	ld	a5,-88(s0)
    1e4e:	17e1                	addi	a5,a5,-8
    1e50:	fcf43823          	sd	a5,-48(s0)
    1e54:	a825                	j	1e8c <schedule_rm+0x232>
            if (thread_first == NULL || entry->thrd->current_deadline < thread_first->current_deadline)
    1e56:	fc043783          	ld	a5,-64(s0)
    1e5a:	cb91                	beqz	a5,1e6e <schedule_rm+0x214>
    1e5c:	fd043783          	ld	a5,-48(s0)
    1e60:	639c                	ld	a5,0(a5)
    1e62:	4bb8                	lw	a4,80(a5)
    1e64:	fc043783          	ld	a5,-64(s0)
    1e68:	4bbc                	lw	a5,80(a5)
    1e6a:	00f75763          	bge	a4,a5,1e78 <schedule_rm+0x21e>
                thread_first = entry->thrd;
    1e6e:	fd043783          	ld	a5,-48(s0)
    1e72:	639c                	ld	a5,0(a5)
    1e74:	fcf43023          	sd	a5,-64(s0)
        list_for_each_entry(entry, args.release_queue, thread_list) {
    1e78:	fd043783          	ld	a5,-48(s0)
    1e7c:	679c                	ld	a5,8(a5)
    1e7e:	faf43023          	sd	a5,-96(s0)
    1e82:	fa043783          	ld	a5,-96(s0)
    1e86:	17e1                	addi	a5,a5,-8
    1e88:	fcf43823          	sd	a5,-48(s0)
    1e8c:	fd043783          	ld	a5,-48(s0)
    1e90:	00878713          	addi	a4,a5,8
    1e94:	689c                	ld	a5,16(s1)
    1e96:	fcf710e3          	bne	a4,a5,1e56 <schedule_rm+0x1fc>
        }
        r.allocated_time = (thread_first->current_deadline - args.current_time);
    1e9a:	fc043783          	ld	a5,-64(s0)
    1e9e:	4bb8                	lw	a4,80(a5)
    1ea0:	409c                	lw	a5,0(s1)
    1ea2:	40f707bb          	subw	a5,a4,a5
    1ea6:	2781                	sext.w	a5,a5
    1ea8:	f6f42423          	sw	a5,-152(s0)
    }

    return r;
    1eac:	f6043783          	ld	a5,-160(s0)
    1eb0:	f6f43823          	sd	a5,-144(s0)
    1eb4:	f6843783          	ld	a5,-152(s0)
    1eb8:	f6f43c23          	sd	a5,-136(s0)
    1ebc:	f7043703          	ld	a4,-144(s0)
    1ec0:	f7843783          	ld	a5,-136(s0)
    1ec4:	863a                	mv	a2,a4
    1ec6:	86be                	mv	a3,a5
    1ec8:	8732                	mv	a4,a2
    1eca:	87b6                	mv	a5,a3
    ...
    1ecc:	853a                	mv	a0,a4
    1ece:	85be                	mv	a1,a5
    1ed0:	646a                	ld	s0,152(sp)
    1ed2:	64ca                	ld	s1,144(sp)
    1ed4:	610d                	addi	sp,sp,160
    1ed6:	8082                	ret
